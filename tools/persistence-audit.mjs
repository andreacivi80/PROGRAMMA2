...
const checks = {
  ...
  forwardCompatibleMigration: app.includes("function normalizeProgress") && app.includes("schemaVersion: 14") && app.includes("normalizeProgress(imported.progress, deviceId())"),
