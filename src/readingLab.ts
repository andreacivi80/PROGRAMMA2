...
let readingChoiceIndex=0;
const q=(prompt:string,options:string[],answer:number,explanationIt:string):Choice=>rotateChoice(detailedChoice({prompt,options,answer,explanationIt}),readingChoiceIndex++);
...
export const readingPassages:ReadingPassage[]=[
  ...
  },
  {
    ...
    questions:[
      ...
      q("What is the passage’s central recommendation?",["Replace automated decisions with human review in most routine cases","Evaluate automation mainly through cost, speed and complaint volumes","Combine automation, meaningful review and accessible alternatives","Keep automation but reserve review for confirmed technical failures","Expand alternative channels while making automated outcomes final"],2,"La conclusione propone automazione per i casi ordinari, revisione proporzionata e canali alternativi accessibili.")
    ]
  }
,
  {
  ...
  },
  {
    ...
    questions:[
      ...
      q("What concern do environmental groups express?",["Congestion may simply move elsewhere","Public transport improvements may attract additional visitors","Residents may oppose changes to museum access","Tourists may avoid areas with stricter transport rules"],0,"Promuovere altri quartieri potrebbe soltanto spostare il problema."),
      q("Which measure best reflects the author’s conclusion?",["Visitor numbers and average spending together","Resident, housing, transport and job indicators together","Tourism revenue and hotel occupancy together","Transport use and souvenir sales together"],1,"La sostenibilità richiede una valutazione multidimensionale.")
    ]
  },
  {
    ...
    questions:[
      q("Why is one citywide temperature figure insufficient?",["Airport readings emphasise short-term weather rather than long-term climate","Neighbourhood conditions create substantial variation","Weather stations are concentrated in the warmest residential districts","Different stations are calibrated for incompatible temperature ranges","Citywide averages exclude measurements collected outside working hours"],1,"Il testo evidenzia differenze locali legate a ombra, suolo e materiali."),
      ...
      q("What distinguishes an equity-based project ranking?",["It considers vulnerability as well as numerical exposure","It prioritises districts with the largest absolute population","It weights measured temperature more heavily than health conditions","It distributes funding equally across districts regardless of risk","It ranks projects by cost efficiency before resident vulnerability"],0,"La valutazione equa include rischio e capacità di risposta."),
