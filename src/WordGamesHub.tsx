...
type GameKind="crossword"|"hangman"|"wordorder"|"matching"|"memory"|"opposites"|"precision"|"wordguess"|"millionaire"|"trivia";
...
export default function WordGamesHub({level,saved,onComplete}:Props){
 ...
 return <section className="wordGamesHub">
  <div className="themeHeading"><span><small>GIOCHI IN INGLESE · {level}</small><h2>Impara giocando</h2></span><b>10 sessioni</b></div>
  <p className="readingHubIntro">Dieci giochi autonomi con vocabolario e strutture calibrati per il livello {level}. Le istruzioni sono in italiano; indizi e contenuti da risolvere restano in inglese.</p>
