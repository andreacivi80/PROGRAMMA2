...
const curatedSupplementaryByUnit: Record<string, Choice[]> = {
  ...
  "c1-academic-argument": [
    { prompt: "Argomentazione · Quale formulazione distingue con precisione correlazione e causalità?", options: ["The findings indicate an association but do not establish causation.", "The findings support a causal interpretation because the association is statistically consistent.", "The findings indicate that the factors are related and therefore probably causally connected.", "The findings establish causation once the most likely confounding variable is considered.", "The findings make a causal explanation preferable, although the direction of the effect remains uncertain."], answer: 0, explanationIt: "Indicate an association but do not establish causation formula una conclusione prudente e metodologicamente corretta." },
  ],
