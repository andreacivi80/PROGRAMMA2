...
(() => {
  ...
  function configureCommitmentColumns(overlay,showLotExpiry){
    ...
    overlay.querySelector('thead tr').innerHTML=`<th>OP</th><th>OV</th><th>Lotto / Layout</th>${showLotExpiry?'<th>Scadenza lotto</th>':''}<th>Data di consegna</th><th>Impegnato</th>`;
