(() => {
  ...
  .formulanodehead.formulaparentrow{display:grid!important;grid-template-columns:minmax(0,1fr)!important;grid-template-rows:auto auto auto!important;gap:0!important;align-items:stretch!important}
  .formulaparentrow .formulaparentmain{grid-column:1!important;grid-row:1!important;width:100%!important}
  .formulaparentrow .formulaparentcosts{box-sizing:border-box;grid-column:1!important;grid-row:2!important;display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:1px!important;width:100%!important;min-width:0!important;min-height:0!important;padding:0!important;border-top:1px solid #dce9e5;border-bottom:1px solid #dce9e5;background:#f4faf7}
  .formulaparentcosts>span{box-sizing:border-box;display:grid!important;min-width:0!important;min-height:38px!important;align-content:center!important;justify-items:center!important;gap:2px!important;padding:5px 3px!important;color:#60766f!important;font-size:6px!important;line-height:1.1!important;text-align:center!important;white-space:normal!important}
  .formulaparentcosts>span+span{border-left:1px solid #dce9e5}.formulaparentcosts b{color:#15564f!important;font-size:9px!important;line-height:1.1!important;white-space:nowrap!important}
  .formulaparentrow .formulainventorylink{box-sizing:border-box;grid-column:1!important;grid-row:3!important;width:100%!important;min-height:27px!important;justify-content:center!important;padding:5px 7px!important;overflow:visible!important;font-size:7.5px!important;text-align:center!important;text-overflow:clip!important;white-space:normal!important}
  .formularootactions{display:grid!important;grid-template-columns:minmax(0,1fr) auto auto!important;gap:4px!important;width:100%!important;min-width:0!important}
  .formularootactions .formulametacost{grid-column:1/-1!important;grid-row:1!important;width:100%!important}.formularootactions .formulalineproduct{grid-column:1/-1!important;grid-row:2!important;justify-self:stretch!important;width:100%!important;max-width:100%!important;padding:4px 6px!important;text-align:center!important}
  .formularootactions .formulatypebadge{grid-column:1!important;grid-row:3!important;justify-self:start!important;min-width:0!important;max-width:100%!important}.formularootactions .formulaactive{grid-column:2!important;grid-row:3!important}.formularootactions .formularootopen{grid-column:3!important;grid-row:3!important}
  @media(max-width:360px){.formulacolheads,.formulanodeopen{grid-template-columns:64px minmax(0,1fr) 58px!important}.formulanodehead:not(.formulaparentrow){grid-template-columns:94px minmax(0,1fr)!important}.formulacosts:not(.formulaparentcosts){gap:7px;padding-right:6px;font-size:7px}.formulacosts:not(.formulaparentcosts) b{font-size:8px}.formulainventorylink{font-size:7px!important}.formulaparentcosts b{font-size:8.2px!important}}
  `;
  ...
  .formulabomrelated{display:grid!important;grid-template-columns:68px minmax(0,1fr)!important;gap:3px 7px!important;padding:6px!important}.formulabomrelated>b{grid-column:1;grid-row:1;font-size:8.5px!important}.formulabomrelated>.formulaparentdesc{grid-column:2;grid-row:1;white-space:normal!important;overflow-wrap:break-word!important}.formulabomrelatedmetrics{grid-column:1/-1;grid-row:2;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1px;border:1px solid #dce9e5;border-radius:5px;background:#f5faf8}.formulabomrelatedmetrics i{display:grid;gap:1px;padding:4px 3px;color:#647a73;font-size:5.8px;font-style:normal;font-weight:900;text-align:center;text-transform:uppercase}.formulabomrelatedmetrics i+i{border-left:1px solid #dce9e5}.formulabomrelatedmetrics strong{color:#174f46;font-size:7.5px;white-space:nowrap}.formulabomrelated>.formulaparentstock{grid-column:1/-1!important;grid-row:3!important;padding-top:2px;font-size:6.5px!important}
  @media(max-width:430px){.formularootactions{grid-template-columns:minmax(0,1fr) auto auto!important}.formularootactions .formulametacost{grid-column:1/-1!important}.formularoottitle b{font-size:13px!important}.formularoottitle span{font-size:8.5px!important}.formulabommetrics b{font-size:8.5px}.formulabommain{grid-template-columns:68px minmax(0,1fr)!important}.formulacolheads{grid-template-columns:68px minmax(0,1fr)!important}}
  `;
  document.head.append(finishedBomStyle);
  ...
  .rawmaterialhead{display:grid;gap:7px;padding:10px;border:1px solid #bfd8c4;border-radius:14px;background:#fff}.rawmaterialhead header{display:flex;align-items:center;justify-content:space-between}.rawmaterialhead h2{margin:0;color:#2b5c35;font:800 18px/1 Georgia,serif}.rawmaterialhead small{color:#657b69;font-size:6.5px;font-weight:950}.rawmaterialfilters{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:5px}.rawmaterialfilters select,.rawmaterialfilters input{min-width:0;height:39px;padding:0 8px;border:1px solid #bcd2c0;border-radius:8px;background:#fff;color:#25452c;font-size:8px;font-weight:850}.rawmaterialfilters select{grid-column:1/3}.rawmaterialfilters button{padding:0 12px;border:0;border-radius:8px;background:#32633c;color:#fff;font-size:8px;font-weight:950}.rawmaterialstatus{color:#647568;font-size:7px;font-weight:850}.rawmaterialrows{display:grid;gap:5px}.rawmaterialrow{box-sizing:border-box;display:grid;grid-template-columns:62px minmax(0,1fr) 62px;gap:3px 5px;width:100%;padding:7px;border:1px solid #d5e3d7;border-left:4px solid #7ca788;border-radius:9px;background:#fff}.rawmaterialmain{display:contents}.rawmaterialmain b{color:#2b5c35;font-size:9px;white-space:nowrap}.rawmaterialmain strong{min-width:0;color:#2e4533;font-size:8px;line-height:1.2}.rawmaterialmain em{overflow:hidden;color:#2e6640;font-size:7px;font-style:normal;font-weight:950;text-align:right;text-overflow:ellipsis;white-space:nowrap}.rawmaterialline{grid-column:1/3;color:#56745e;font-size:6.5px;font-weight:950;text-transform:uppercase}.rawmaterialmetrics{grid-column:1/4;display:grid;grid-template-columns:repeat(3,1fr);gap:4px}.rawmaterialmetrics button,.rawmaterialmetrics span{min-height:29px;display:grid;place-items:center;padding:3px;border:1px solid #dce8de;border-radius:7px;background:#f6faf7;color:#345b3d;font-size:6.2px;font-weight:900;text-align:center}.rawmaterialmetrics button{cursor:pointer}.rawmaterialuses{grid-column:1/4;margin-top:1px;border:1px solid #d8e6da;border-radius:7px;background:#f7faf7}.rawmaterialuses>summary{padding:5px 7px;color:#32633c;font-size:6.5px;font-weight:950;cursor:pointer}.rawmaterialuse{display:grid;grid-template-columns:62px minmax(0,1fr);gap:6px;width:100%;padding:5px 6px;border:0;border-top:1px solid #e2ebe3;background:#fff;color:#34533b;text-align:left}.rawmaterialuse b{font-size:7px}.rawmaterialuse span{min-width:0;font-size:6.5px}.rawmaterialalternatives{box-sizing:border-box;grid-column:1/4;min-width:0;overflow:hidden;margin-top:2px;border:1px solid #bcd5c2;border-radius:8px;background:#fff}.rawmaterialaltheading,.rawmaterialalternative{box-sizing:border-box;display:grid;grid-template-columns:56px minmax(0,1fr) 52px 58px;align-items:center;gap:3px;min-width:0}.rawmaterialaltheading{width:100%;padding:4px;background:#eaf4ec;color:#4f6e56;font-size:5.5px;font-weight:950;text-align:right}.rawmaterialaltheading b{text-align:left}.rawmaterialalternative{width:100%;min-height:31px;padding:5px 4px;border:0;border-top:1px solid #e0eae2;background:#fff;color:#2e4d35;text-align:left}.rawmaterialalternative b{font-size:7.2px;white-space:nowrap}.rawmaterialalternative strong{min-width:0;overflow:hidden;color:#304a36;font-size:6.6px;text-overflow:ellipsis;white-space:nowrap}.rawmaterialalternative span{overflow:hidden;font-size:6.1px;font-weight:900;text-align:right;text-overflow:ellipsis;white-space:nowrap}.rawmaterialalternative .rawmaterialaltstock{color:#17685f}.formulaauditskeleton{display:grid;gap:4px;padding:5px}.formulaauditskeleton span{height:31px;border:1px solid #dfe9e6;border-radius:8px;background:linear-gradient(90deg,#f6faf8,#eaf2ef,#f6faf8);background-size:200% 100%;animation:formulaPulse 1.2s linear infinite}.formularootactions .formulalineproduct{max-width:130px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;background:#ffffff24!important;color:#fff!important}
  ...
  materialAuditPanel.innerHTML = `<summary>Materie prime codificate da verificare <b>7000–7999</b></summary><form id="formulaMaterialAuditRange" class="schedulerange formulaauditfilters"><label>Dal <input name="from" type="date" lang="it-IT"><output data-audit-date="from">gg/mm/aaaa</output></label><label>Al <input name="to" type="date" lang="it-IT"><output data-audit-date="to">gg/mm/aaaa</output></label><input type="search" data-audit-query placeholder="Cerca codice o descrizione"><button type="button" data-audit-show>Mostra</button><button type="button" class="secondary" data-audit-reset>Azzera filtri</button><div class="formulaauditstatus" data-audit-status>Controllo Technics in preparazione…</div></form><div class="formulaauditgroups" data-audit-groups><div class="formulaauditskeleton" aria-label="Caricamento materie prime"><span></span><span></span><span></span><span></span></div></div>`;
  ...
  const updateBackButton = () => {
    ...
    if (workspace === "rawmaterials" && document.querySelector(".rawmaterialrow")) {
      backButton.classList.remove("hidden");
      backButton.dataset.mode = "rawmaterials";
      backButton.querySelector("b").textContent = "Nuova ricerca";
      return;
    }
    backButton.dataset.mode = "formula";
  ...
  const nodeRow = (node, relation = "component") => {
    ...
    if (relation === "component") {
      return `<article class="formulanode formulabomitem" data-formula-id="${node.id}"><div class="formulanodehead"><button type="button" class="formulanodeopen formulabommain" data-formula-expand="${node.id}" aria-expanded="false"><b>${esc(node.code)}</b><strong>${esc(node.description)}</strong></button><div class="formulabommetrics"><span>Quantità usata<b>${measure}</b></span><span>Prezzo unitario<b>${euro(node.unitCost)}</b></span><span>${contributionLabel}<b>${euro(node.costContribution)}</b></span></div><button type="button" class="formulainventorylink" data-formula-inventory="${esc(node.code)}">Giacenza ${num2(node.totalStock)} ${esc(node.unit || "")}</button></div><div class="formulanodedetail hidden"></div></article>`;
    }
    const costBlock = relation === "component"
      ? `<span class="formulacosts"><span>Prezzo unitario <b>${euro(node.unitCost)}</b></span><span>${contributionLabel} <b>${euro(node.costContribution)}</b></span></span>`
      : relation === "parent" && Number(node.formulaCost) > 0
        ? `<span class="formulacosts formulaparentcosts"><span>Costo finito<b>${euro(node.formulaCost)}/${esc(node.unit || "Pz")}</b></span><span>Bulk<b>${euro(node.formulaBulkCost)}</b></span><span>Packaging<b>${euro(node.formulaPackagingCost)}</b></span></span>`
        : "";
    return `<article class="formulanode" data-formula-id="${node.id}"><div class="formulanodehead${relation === "parent" ? " formulaparentrow" : ""}"><button type="button" class="formulanodeopen${relation === "parent" ? " formulaparentmain" : ""}" data-formula-expand="${node.id}" aria-expanded="false"><b>${esc(node.code)}</b><strong>${esc(node.description)}</strong>${relation === "component" ? `<span class="formulapct">${measure}</span>` : `<span class="formulapct">${esc(node.type || "Apri")}</span>`}</button><button type="button" class="formulainventorylink" data-formula-inventory="${esc(node.code)}">Giacenza ${num2(node.totalStock)} ${esc(node.unit || "")}</button>${costBlock}</div><div class="formulanodedetail hidden"></div></article>`;
  };
  const sectionBlock = (title, items, relation) => {
    const ordered = relation === "component"
      ...
      : items;
    return `<section class="formulasection" data-formula-section="${relation}"><h3>${esc(title)} · ${ordered.length}</h3>${ordered.length ? `${relation === "component" ? '<div class="formulacolheads"><span>Codice</span><span>Componente</span></div>' : ""}<div class="formulanodes">${ordered.map((x) => nodeRow(x, relation)).join("")}</div>` : '<div class="formulaempty">Nessun collegamento presente in Technics.</div>'}</section>`;
  };
  ...
  const renderBomRelated = (item) =>
    `<button type="button" class="formulaparent formulabomrelated" data-formula-related-id="${Number(item.id) || 0}"><b>${esc(item.code)}</b><span class="formulaparentdesc">${esc(item.description)}</span><span class="formulabomrelatedmetrics"><i>Quantità <strong>${num2(item.quantity)} ${esc(item.bomUnit || item.unit || "UM")}</strong></i><i>Prezzo unitario <strong>${euro(item.unitCost)}</strong></i><i>Costo riga <strong>${euro(item.costContribution)}</strong></i></span><span class="formulaparentstock">Giacenza ${num2(item.totalStock)} ${esc(item.unit || "")}</span></button>`;
  ...
  const load = async (code, quiet = false) => {
    ...
    try {
      const payload = await api(
        `/api/formulas/search?code=${encodeURIComponent(code)}`,
        quiet,
      );
  ...
  backButton.addEventListener("click", () => {
    ...
    if (backButton.dataset.mode === "rawmaterials" && shell.dataset.workspace === "rawmaterials") {
      clearTimeout(rawMaterialTimer);
      rawMaterialToken += 1;
