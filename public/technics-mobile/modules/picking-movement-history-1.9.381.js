(() => {
  ...
  const show = async (code, lot) => {
    ...
    try {
      ...
      count.textContent = history.movementCount + ' movimenti totali · ' + (expanded ? 'tutti visibili' : history.recentMovements.length + ' più recenti');
