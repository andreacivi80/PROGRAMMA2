...
(() => {
  ...
  function configureCommitmentColumns(overlay,showLotExpiry){
    ...
    overlay.querySelector('thead tr').innerHTML=`<th>OP</th><th>OV</th><th>Lotto / Layout</th><th>Data di consegna</th>${showLotExpiry?'<th>Scadenza lotto</th>':''}<th>Impegnato</th>`;
