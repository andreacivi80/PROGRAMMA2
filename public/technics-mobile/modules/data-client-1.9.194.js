(()=>{
  ...
  window.TechnicsDataClient=Object.freeze({parseText,read,fetchJson,invalidate,diagnostics,incompleteMessage,version:"1.9.194"});
  document.documentElement.dataset.dataClient="1.9.194";
})();
