(() => {
  ...
  .formularoot>header{display:flex;align-items:center;gap:6px;padding:8px 9px}.formularoottitle{display:flex;min-width:0;flex:1;align-items:baseline;gap:7px}.formularoottitle b{flex:none;font-size:15px;white-space:nowrap}.formularoottitle span{min-width:0;overflow:hidden;font-size:10px;font-weight:850;text-overflow:ellipsis;white-space:nowrap}.formularootactions{display:flex;flex:none;align-items:center;gap:4px}.formularootactions small{padding:3px 5px;border-radius:6px;background:#ffffff1f;font-size:6px;font-weight:950;white-space:nowrap}.formularootactions .formulaactive{background:#dff4e9;color:#155b47}.formularootopen{min-height:27px;padding:3px 7px;border:1px solid #ffffff66;border-radius:7px;background:#fff;color:#15564f;font-size:7px;font-weight:950}
  .formulameta span{display:flex;align-items:center;justify-content:center;gap:4px;padding:5px 3px}.formulameta b{font-size:10px}.formulasection>h3{padding:6px 8px}.formulanodehead{display:block!important;padding:0!important}.formulanodeopen{display:grid;grid-template-columns:minmax(62px,.55fr) minmax(0,1.45fr) 45px;gap:3px 6px;align-items:center;width:100%;padding:6px 7px;border:0;background:#fff;text-align:left}.formulanodeopen[aria-expanded="true"]{background:#eef8f5}.formulanodeopen b{color:#15564f;font-size:9px;white-space:nowrap}.formulanodeopen strong{min-width:0;color:#243e37;font-size:7.5px;line-height:1.2}.formulanodeopen .formulapct{font-size:7.5px}.formulainventorylink{display:flex;width:100%;align-items:center;justify-content:flex-start;gap:4px;padding:3px 7px 5px;border:0;background:#fff;color:#55716a;font-size:6.5px;font-weight:900;text-align:left;white-space:nowrap}.formulainventorylink::after{content:'›';color:#17685f;font-size:12px;line-height:.6}.formulainventorylink:hover,.formulainventorylink:focus{background:#edf7f4;color:#15564f}
  .formulanodedetail{position:fixed;z-index:19980;inset:max(62px,env(safe-area-inset-top)) max(8px,calc((100vw - 680px)/2)) max(8px,env(safe-area-inset-bottom));display:grid;grid-template-rows:auto auto minmax(0,1fr);gap:4px;overflow:hidden;padding:6px;border:1px solid #a9c9c2;border-radius:14px;background:#f5faf8;box-shadow:0 16px 60px #102b2580}.formulanodedetail.hidden{display:none}.formuladetailhead{display:flex;align-items:center;gap:6px;min-width:0;padding:2px 2px 5px}.formuladetailhead b{flex:none;color:#15564f;font-size:11px;white-space:nowrap}.formuladetailhead span{min-width:0;flex:1;overflow:hidden;color:#304c44;font-size:8px;font-weight:850;text-overflow:ellipsis;white-space:nowrap}.formuladetailclose{width:28px;height:28px;flex:none;border:1px solid #b9d8d2;border-radius:50%;background:#fff;color:#15564f;font-size:17px;line-height:1}.formuladetailnav{gap:3px}.formuladetailnav button{min-height:28px;padding:2px;font-size:6.5px}.formulaunit{min-height:0;overflow:auto}.formulaunit h4{position:sticky;z-index:1;top:0;padding:4px 6px;font-size:7px}.formulaunit>div{gap:2px;padding:4px}.formulainci,.formulastock,.formuladoc,.formulaparent{gap:2px 5px;padding:4px 5px;border-radius:5px}.formuladoc{grid-template-columns:58px minmax(0,1fr) 36px}.formuladoc b{font-size:6.5px;white-space:nowrap}.formuladoc span{overflow:hidden;font-size:6.5px;text-overflow:ellipsis;white-space:nowrap}.formuladoc button{min-height:24px;padding:2px;font-size:6px}.formulastock{padding:5px 6px!important}.formulastocklot,.formulastockqty{font-size:9px!important}.formulastockplace{font-size:6.5px!important}.formulastockwarehouse{font-size:6px!important}.formulaparent small{display:none}
  ...
  @media(max-width:430px){.formularoot>header{gap:4px}.formularoottitle{gap:5px}.formularoottitle b{font-size:13px}.formularoottitle span{font-size:8px}.formularootactions small{font-size:5.5px}.formularootopen{padding:2px 5px}.formulameta{grid-template-columns:repeat(4,1fr)}.formulameta span{font-size:5.3px}.formulameta b{font-size:8px}.formulanodeopen{grid-template-columns:minmax(57px,.52fr) minmax(0,1.48fr) 42px}.formuladoc{grid-template-columns:55px minmax(0,1fr) 34px}.formulanodedetail{inset:max(58px,env(safe-area-inset-top)) 5px max(5px,env(safe-area-inset-bottom));border-radius:12px}}
  `;
  ...
  const renderRoot = (data) => {
    ...
    result.innerHTML = `<article class="formularoot"><header><div class="formularoottitle"><b>${esc(a.code)}</b><span>${esc(a.description)}</span></div><div class="formularootactions"><small>${esc(a.type)}</small><small class="formulaactive ${a.active ? "" : "inactive"}">${a.active ? "ATTIVO" : "NON ATTIVO"}</small><button type="button" class="formularootopen" data-formula-expand="${a.id}" aria-expanded="false">Scheda</button></div></header><div class="formulameta"><span>Distinta<b>${a.componentCount}</b></span><span>Confezionati<b>${packaged.length}</b></span><span>INCI<b>${a.inciCount}</b></span><span>Giacenza<b>${num2(a.totalStock)} ${esc(a.unit)}</b></span></div><div class="formulanodedetail hidden" data-root-detail></div></article>${sectionBlock("DISTINTA BASE · MATERIE PRIME", data.components || [], "component")}${sectionBlock("CONFEZIONATI", packaged, "parent")}`;
    updateBackButton();
  };
