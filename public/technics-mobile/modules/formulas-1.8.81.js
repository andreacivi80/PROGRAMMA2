(() => {
  ...
  @media(max-width:430px){.formularoot>header{gap:4px}.formularoottitle{gap:5px}.formularoottitle b{font-size:13px}.formularoottitle span{font-size:8px}.formularootactions small{font-size:5.5px}.formularootopen{padding:2px 5px}.formulameta{grid-template-columns:repeat(4,1fr)}.formulameta button{font-size:5.3px}.formulameta b{font-size:8px}.formulanodeopen{grid-template-columns:minmax(57px,.52fr) minmax(0,1.48fr) 42px}.formuladoc{grid-template-columns:55px minmax(0,1fr) 34px}.formulanodedetail{inset:max(58px,env(safe-area-inset-top)) 5px max(5px,env(safe-area-inset-bottom));border-radius:12px}}
  `;
