# English Coach 9.5 — stato verificato

Legenda: **IMPLEMENTATO**, **VERIFICATO**, **NON APPLICABILE**, **RINVIATO CON MOTIVAZIONE**.

## 1. Versione e consegna

- **VERIFICATO** — sorgenti e versione web usano la stessa build 9.5, con data e identificativo visibili; la pubblicazione viene aggiornata soltanto dopo il collaudo completo.
